...
{
  $query = "SELECT * FROM `engineer` WHERE `username`='$_POST[username]' AND `password`='$_POST[password]' ";
  $result = mysqli_query($conn,$query);
  if(mysqli_num_rows($result)==1)
  {
    session_start();
    $_SESSION['engineerlogin']=$_POST['username'];
          ...
          <form method="POST">
            <div class="card bg-white text-black mt-5">
              <div class="card-body p-5 text-center">
                <div class="mb-4">
                    <h2 class="mb-2">Engineer Login</h2>
                    <div class="mb-4 mt-4">
